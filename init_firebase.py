...
3. Creates the Admin Firebase Auth user.
4. Inserts the sample Firestore documents.
...
def delete_collection(collection_ref, batch_size=100):
    ...
    while True:
        ...
        for doc in docs:
            # Delete nested subcollections before deleting the parent document.
...
def setup_sample_data(demo_accounts):
    ...
    db.collection("Admins").document("A01").set(admin_data)
    print("   ✓ Collection 'Admins' -> Document 'A01' created.")
    ...
    employee_data = {
        ...
        "email": emp_acc["email"],
        "role": "employee",
        "department": "Dining Hall Counter",
        "dob": "10-05-1992",
        "doj": "01-08-2022",
        "createdAt": "15-09-2026",
    }
    ...
    db.collection("Students").document("M102").set(student_data)
    print("   ✓ Collection 'Students' -> Document 'M102' created.")
